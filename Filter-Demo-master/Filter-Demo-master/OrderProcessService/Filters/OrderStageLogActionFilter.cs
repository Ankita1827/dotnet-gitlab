...
namespace OrderProcessService.Filters
{
    ...
    public class OrderStageLogActionFilter:ActionFilterAttribute
    {
        ILogger<OrderStageLogActionFilter> _logger;
        public OrderStageLogActionFilter(ILogger<OrderStageLogActionFilter> logger)
        {
            _logger = logger;
        }
